...
set :deploy_to, '/web/huanxing_im'
set :current_path, 'current'
set :repository, 'https://github.com/blackdust/huanxing_im.git'
set :branch, 'master'
set :user, 'root'
set :term_mode, nil
...
task :setup => :environment do
  ...
  order = MinaUtil::Builder.ask_mongoid('huanxing_im')
  ...
  nginx = MinaUtil::Builder.ask_nginx('huanxing_im', '/web/huanxing_im')
  queue! %[echo '#{nginx}' > "/etc/nginx/conf.d/huanxing_im.conf"]
  #test
  #queue! %[echo '#{nginx}' > "/home/dd/huanxing_im.conf"]
